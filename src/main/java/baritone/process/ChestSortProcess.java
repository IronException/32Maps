...
public final class ChestSortProcess extends BaritoneProcessHelper implements IChestSortProcess, AbstractGameEventListener {
    ...
    public SubProcess getProcessBuild() {
        ...
        */
        ...
        return new DoInContainerProcess(targetPos, new ChatProcess("in chest", new Epsilon()), new ChatProcess("finished", new Epsilon()));/*
                new ChatProcess("start",
                new EditChestShulkerProcess(targetPos, new SlotHelper(0, ContainerType.NORMAL_CHEST), hotbarSlot, shulkerPos,
